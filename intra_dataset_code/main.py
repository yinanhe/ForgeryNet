...
Author: Yuanjun Xiong, Zhengkui Guo, Yuanhan Zhang, Yinan He
Contact: forgerynet@gmail.com
...
from tsn_predict import TSNPredictor as ForgeryNetDetector


def run_test(detector_class, image_iter, get_prob):
    """
    In this function we create the detector instance. And evaluate the wall time for performing ForgeryNetDetector.
    """
    ...
    if get_prob:
        logging.info("""
        ================================================================================
        All images finished, showing probability info below:
        ================================================================================
        """)

        for key in output_probs:
            print(key,' ',output_probs[key])
...
if __name__ == '__main__':
    ...
    run_test(ForgeryNetDetector, celebA_spoof_image_iter, False)
